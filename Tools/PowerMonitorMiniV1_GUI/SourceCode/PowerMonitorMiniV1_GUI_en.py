...
class PowerMonitorMiniV1_GUI:
    def __init__(self):
        ...
        self.label_pd_id_set = tk.Label(self.frame_pd_set, text="ID Set")
        ...
        self.label_pd_voltage_set = tk.Label(self.frame_pd_set, text="Voltage Set(mV)")
        ...
        self.label_pd_current_set = tk.Label(self.frame_pd_set, text="Current Limiting(mA)")
        ...
        self.btn_pd_refresh = ttk.Button(
            self.frame_pd_set, text="Refresh", command=self.btn_pd_refresh_click
        )
        self.btn_pd_refresh.grid(row=3, column=3, sticky=tk.W, padx=1)
        self.btn_pd_apply = ttk.Button(
            self.frame_pd_set, text="Apply", command=self.btn_pd_apply_click
        )
